...
SUBAGENTS = [
    ...
    ("SA-08", "route-celo-sol", "tests/test_routes.py::test_base_sol_bridge_fee"),
    ...
    ("SA-11", "celo-uniswap-swap", "tests/test_base.py::test_swap_router_configured"),
    ("SA-12", "solana-jupiter-swap", "tests/test_solana.py::test_keypair_from_base58"),
    ("SA-13", "wallet-celo-hot", "tests/test_base.py::test_celo_address_from_key"),
